$(function(){
	lineandbar();
	function lineandbar(){
		var a=echarts.init(document.getElementById("lineandbar"));
		var option={
			tooltip:{
			...
			color: ['rgba(215, 238, 255, 0.4)','rgba(255, 170, 127, 76)'],
			 legend:{
