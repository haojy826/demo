...
using MyPhoneBook.Sessions;
using MyPhoneBook.Web.Models.Account;
using MyPhoneBook.Web.Views.Shared.Components.TenantChange;

namespace MyPhoneBook.Web.Controllers
{
    public class AccountController : MyPhoneBookControllerBase
    {
